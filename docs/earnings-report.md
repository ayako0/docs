...
<div>
  <p>(Net income / common shares outstanding)</p>
  <p class="mb4">
    An algorithm that trades stocks with the highest earnings per share values
    weekly.
  </p>
  <div class="clearfix">
    <p class="date mt0">
    ...
    <div class="relative ml0 xs-col xs-col-9">
      <div class="border-box pr2a">
        <iframe
          ...
          frameborder="0"
          scrolling="no"
          src="//plotly.com/~ayako0/110.embed?link=false&modebar=false&logo=false"
        ></iframe>
      </div>
    </div>
  ...
  <div class="clearfix mb4">
    <div class="md-col-8">
      <div class="footnotes">
        ...
        <a href="https://www.investopedia.com/terms/e/eps.asp">Investopedia</a>
        <br />
        <br />
        <br />
